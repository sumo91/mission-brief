# Mission Brief case: detailed plan preservation

Run this case in a fresh session against a frozen candidate Skill. Give the Agent only the files in `evals/fixtures/mb-001-detailed-plan-preservation/`, the candidate runtime Skill, and an isolated scratch repository in which to save the result.

## Observe

- Whether the adopted retirement, compatibility, permissions, and behavioral proof remain binding without importing candidate implementation choices.
